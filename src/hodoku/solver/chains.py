"""Chain solver: X-Chain, XY-Chain, Remote Pair, Turbot Fish.

Nice Loop / AIC / Grouped Nice Loop are handled by tabling.py (TablingSolver),
not here.  This module mirrors only the portions of Java's ChainSolver that are
actually wired up in step_finder.py.
"""
